...
public class PlayGameScreen extends JPanel {
	...
	private Font primaryFont = new Font("goudy stout", Font.BOLD, 56), failFont = new Font("comic sans", Font.BOLD, 56);
	...
	public void paintComponent(Graphics g) {
		...
		g.setColor(new Color(150, 255, 255)); //color for the blue sky
		g.fillRect(0, 0, screenWidth, screenHeight*7/8); //create the sky rectangle
		g.setColor(new Color(101, 67, 33)); //brown color for ground
